          ...
          items: <BottomNavigationBarItem>[
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath('home'),
                colorFilter: const ColorFilter.mode(primary, BlendMode.srcIn),
              ),
              activeIcon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath('homeSelected'),
                colorFilter: const ColorFilter.mode(primary, BlendMode.srcIn),
              ),
            ...
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath('Order'),
                colorFilter: const ColorFilter.mode(primary, BlendMode.srcIn),
              ),
              activeIcon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath('orderselected'),
                colorFilter: const ColorFilter.mode(primary, BlendMode.srcIn),
              ),
            ...
            BottomNavigationBarItem(
              icon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath('Product'),
                colorFilter: const ColorFilter.mode(primary, BlendMode.srcIn),
              ),
              activeIcon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath('productSelected'),
                colorFilter: const ColorFilter.mode(primary, BlendMode.srcIn),
              ),
            ...
            BottomNavigationBarItem(
              ...
              activeIcon: SvgPicture.asset(
                DesignConfiguration.setNewSvgPath('profileSelected'),
                colorFilter: const ColorFilter.mode(primary, BlendMode.srcIn),
              ),
