...
class _StockManageBottomsheetContainerState
  ...
  late final bool isVariantStockManage = widget.product.stockType == "2";
  ...
  String getCurrentStock() {
    final stock =
        isVariantStockManage ? selectedVariant.stock! : widget.product.stock!;
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: isLoading
                          ...
                          : Text(
                              getTranslated(context, 'SAVE_SETTINGS')!,
